...
# myaccess.execute('CREATE TABLE customer_details(cus_id int primary key, cus_name varchar(50), phone varchar(20))')


# sql = 'INSERT INTO customer_details (cus_id, cus_name, phone) VALUES (%s,%s,%s)'
# val = (6, 'Kritika', '6045678922')
